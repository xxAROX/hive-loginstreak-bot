...
4. Now run `npm run "join hive"` to manually join / To make it automatic run `npm run "join hive automatic"` and the program joins at 4:20am every day on The Hive(recommend to use tmux or screen on Linux OS).
